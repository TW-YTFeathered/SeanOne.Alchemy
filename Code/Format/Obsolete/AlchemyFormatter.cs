...
namespace SeanOne.Alchemy
{
    ...
    /// </summary>
    [Obsolete("Please use Alchemy.Format or Alchemy.Transform instead. This class will be removed in a future version.")]
    public partial class AlchemyFormatter
    {
        ...
        /// </exception>
        [Obsolete("This method is obsolete. Use Alchemy.Format(object, string) instead.")]
        ...
        /// Thrown when <paramref name="obj"/> is null or <paramref name="dslInstruction"/> is null or empty.
        /// </exception>
        [Obsolete("This method is obsolete. Use Alchemy.FormatAsync(object, string) instead.")]
